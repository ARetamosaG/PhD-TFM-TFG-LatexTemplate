...
disponibilidad de librerías que facilitan el tratamiento de datos y la implmentación de los algoritmos estudiados.
...
Problema del Viajante, así como otros problemas relacionados \cite{tsplib}. Fue publicada en 1991, por el alemán Gerhald Reinelt
...
\begin{itemize}
  \item La \textbf{palabra} representa la inicial del autor que diseñó el problema, un acrónimo de la procedencia de los datos o
  el tipo de problema real del que se extrajo.
...
\begin{itemize}
  ...
  \item \textbf{EDGE\_WEIGHT\_TYPE}: indica cómo se determinan las instancias. En este caso, los nodos se presentan como \textbf{
...
Para conectar el uso del lenguaje Python y la colección de instancias TSPLIB, se va utilizar una librería de Python llamada
...
Se puede crear una objeto del tipo \texttt{networkx.Graph} a partir de la instancia:
