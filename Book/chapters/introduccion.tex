...
Detrás de cada búsqueda en Internet, cada recomendación en una plataforma, o cada sistema de inteligencia artificial, existe un 
...
cuantificar dicha complejidad temporal se utiliza la notación asintótica, haciendo uso del término \textbf{O grande}. Esta
...
clase es la NP\footnote{\textit{Nondeterministic Polynomial time}.}, cuyos problemas son aquellos que se pueden 
verificar\footnote{Un problema verificable es aquel que, dada una solución candidata, se puede verificar dicha solución en 
tiempo polinómico.} en tiempo polinómico si es correcta, aunque no se conoce ningún algoritmo capaz de encontrar dicha 
solución en tiempo polinómico \cite{cormen2009}. Junto a esta clase, resulta necesario introducir un concepto relacionado pero
distinto, que permite comparar el grado de dificultad entre problemas: el concepto de NP-difícil. Un problema es NP-difícil si 
es, como mínimo, tan difícil de resolver como cualquier problema de la clase NP. Formalmente, esto significa que cualquier 
problema de NP puede transformarse o reducirse en él usando un procedimiento que tarda un tiempo polinómico. Combinando estos 
dos últimos términos se llega a la tercera y última clase: la NP-completo. Un problema es NP-completo si pertenece a la clase NP,
y además, es NP-difícil \cite{cormen2009}. Los problemas NP-completos son, por tanto, los más difíciles dentro de NP: no se 
conoce ningún algoritmo exacto que se ejecute en tiempo polinómico para ninguno de ellos, y sus mejores algoritmos exactos 
conocidos son, generalmente, de orden exponencial.
