...
\newcommand{\myBookTitleSpanish}{Estudio, implementación y comparación experimental de metaheurísticas para la resolución del problema del viajante}
\newcommand{\myBookTitleEnglish}{Unified Template for the Generation of PFCs, TFGs, TFMs and PhD Thesis}
\newcommand{\myThesisKeywords}{Problema del viajante, metaheurísticas, algoritmos genéticos, colonia de hormigas, recocido simulado, búsqueda tabú} % (máximo de cinco)
\newcommand{\myThesisKeywordsEnglish}{Travelling salesman problem, metaheuristics, genetic algorithms, ant colony, simulated annealing, tabu search} % (up to a maximum of five)
\newcommand{\myConfidentialContent}{No} % This can be Yes or No, used
                                        % in MUII as of July 2021

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Author data
\newcommand{\myAuthorName}{Adrián}
\newcommand{\myAuthorSurname}{Retamosa Gómez}
\newcommand{\myAuthorFullName}{\myAuthorName{} \myAuthorSurname{}}
\newcommand{\myAuthorGender}{male} 
\newcommand{\myAuthorEmail}{adrian.retamosa@edu.uah.es}
\newcommand{\myAuthorDNI}{03247820-J}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calendar dates 
\newcommand{\myThesisProposalDate}{30 de junio de 2026} % "Anteproyecto" date

\newcommand{\myThesisDepositDate}{40 de septiembre de 2026}
\newcommand{\myThesisDepositDateEnglish}{September 40\textsuperscript{th}, 2026}
...
\newcommand{\myThesisDefenseDate}{40 de septiembre de \myThesisDefenseYear{}}
\newcommand{\myThesisdefenseDateEnglish}{September 40\textsuperscript{th}, \myThesisDefenseYear{}}
