...
\newcommand{\myThesisKeywords}{Problema del viajante, metaheurísticas, algoritmos genéticos, colonia de hormigas, recocido simulado, búsqueda tabú
} % (máximo de cinco)
\newcommand{\myThesisKeywordsEnglish}{Travelling salesman problem, metaheuristics, genetic algorithms, ant colony, simulated
annealing, tabu search} % (up to a maximum of five)
