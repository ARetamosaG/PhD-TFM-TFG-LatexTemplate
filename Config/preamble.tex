...
%%%python
% Definición de colores agradables y profesionales
\definecolor{pybackground}{rgb}{0.97, 0.97, 0.98}  % Gris muy claro para el fondo
\definecolor{pyaltbackground}{rgb}{0.93, 0.94, 0.96} % Tono ligeramente distinto para alternar
\definecolor{pyframe}{rgb}{0.8, 0.8, 0.85}          % Gris sutil para el marco
\definecolor{pykeyword}{rgb}{0.13, 0.47, 0.75}       % Azul corporativo para palabras clave
\definecolor{pycomment}{rgb}{0.25, 0.50, 0.35}       % Verde apagado para comentarios
\definecolor{pystring}{rgb}{0.75, 0.20, 0.20}       % Rojo/granate suave para strings
%%%
...
\lstdefinestyle{PythonStyle}{
    ...
    breaklines=true,                     
    captionpos=b,
    % --- MAGIA PARA ALTERNAR COLORES DE FONDO EN CADA LÍNEA ---
    moredelim=**[is][\colorbox{pyaltbackground}]{\%\{}{\%\}}
}
